        ...
        try
        {
            ...
            if (items != null)
            {
                ...
                else
                {
                    ...
                    //string file = Ecx.Rule.Helpers.DocumentHelper.DownloadDocument(token, domain, HttpUtility.UrlDecode(documentUrl));

                    // Try to convert
                    var fileExtension = CmsHelper.GetCmsUrlExtension(documentUrl);
