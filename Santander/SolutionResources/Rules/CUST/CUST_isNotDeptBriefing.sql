...
BEGIN
    ...
    join tbl_dict_customword cw on cw.col_id = cb.COL_CDM_BRIEFINGBRIEFING_PRO AND UPPER(cw.col_Code) != 'DEPARTMENTAL_BRIEFING'
    join tbl_dict_customcategory cc on cw.col_wordcategory = cc.col_id AND UPPER(cc.col_code) = 'BRIEFING_PRODUCT'
