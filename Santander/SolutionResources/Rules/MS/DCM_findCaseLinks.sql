...
BEGIN
    ...
    SELECT 
    CASE WHEN LENGTH(V_RELATED_CASE_IDS) > 255 THEN SUBSTR(V_RELATED_CASE_IDS ,1,252)||'...'
    ELSE V_RELATED_CASE_IDS
    END INTO V_RELATED_CASE_IDS
    FROM DUAL;
