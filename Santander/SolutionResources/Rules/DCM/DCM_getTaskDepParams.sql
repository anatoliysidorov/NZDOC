select td.col_id as ID, ctsk.col_id as CTaskId, cmtsi.col_id as CTaskStateInitId,
       ...
       crc.col_code as CResolutionCode, prc.col_code as PResolutionCode
      from tbl_task ctsk
      ...
      left join tbl_stp_resolutioncode crc on ctsk.col_taskstp_resolutioncode = crc.col_id
      ...
      where td.col_id = :TaskDependencyId