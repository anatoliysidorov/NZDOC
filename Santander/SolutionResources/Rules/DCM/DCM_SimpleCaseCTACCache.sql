SELECT --BASIC DATA
	...
	sc.ms_commoncode AS MS_CommonCode,
    --Goal SLA
...
inner join tbl_ac_casetypeviewcache ctvc on sc.CaseSysType_Id = ctvc.col_casetypeviewcachecasetype and ctvc.col_accesssubjectcode = sys_context('CLIENTCONTEXT', 'AccessSubject')