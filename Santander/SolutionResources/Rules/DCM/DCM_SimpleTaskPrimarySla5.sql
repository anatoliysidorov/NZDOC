SELECT
           ...
           (select SlaDateTime from vw_DCM_SlaEventListVW where TaskId = t.col_id and SlaEventTypeCode = 'GOAL') as GoalSlaDateTime,
           --DeadLine (DLine) SLA
           ...
           (select SlaDateTime from vw_DCM_SlaEventListVW where TaskId = t.col_id and SlaEventTypeCode = 'DEADLINE') as DLineSlaDateTime,
           ----
           /*--CALCULATED*/
           tst.col_iconCode AS CALC_ICON
FROM
--(select t.* from tbl_task t where t.col_casetask = 261651) t
tbl_task t
