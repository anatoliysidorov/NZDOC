...
begin
  ...
  FOR rec IN (SELECT te.col_processorcode, tsi2.col_id, te.col_taskeventmomnttaskeventcc, te.col_taskeventtypetaskeventcc,
  ...
  LOOP
    BEGIN
      ...
      VALUES (rec.col_processorcode, rec.col_id, rec.col_taskeventmomnttaskeventcc, rec.col_taskeventtypetaskeventcc,
              rec.col_taskeventorder, v_createdby, v_createddate, 
