declare
  v_ExtPartyId Integer;
  v_ExtPartyExtId Integer;
...
begin
  ...
  if v_ProcessorName is null then
    return '<CustomData><Attributes></Attributes></CustomData>';
  end if;
/*  begin
...
END IF;	
  ...
  v_query := v_query || '); end;';
  execute immediate v_query using out v_result, v_ExtPartyId, out v_Output;
  return v_Output;
end;