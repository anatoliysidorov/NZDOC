...
begin
    ...
    FOR rec IN(select s1.RTTaskStateInitId,
            s1.RTTaskEventId,
            s1.RuleParamCode,
            s1.RuleParamValue,
    ...
    from   (select    tsi.col_id as DTTaskStateInitId,
                       ...
                       tsi.col_map_taskstateinitcctaskcc as TaskStateInitTaskId,
                       tsi.col_map_tskstinitcc_initmtd as TaskStateInitMethodId,
                       tsi.col_map_tskstinitcc_tskst as TaskStateInitStateId,
                       tsi.col_map_taskstinitcctasktmpl as TaskTmplId,
                       tsi2.col_id as RTTaskStateInitId,
                       tsi2.col_map_taskstateinitcctaskcc as TaskId,
                       null as RTTaskId,
                       arp.col_id as AutoRuleParamId,
                       arp.col_paramcode as RuleParamCode,
                       arp.col_paramvalue as RuleParamValue,
                       arp.col_ruleparcc_taskstateinitcc as RuleParamTaskStateInitId,
                       arp.col_taskeventccautoruleparmcc as RuleParamTaskEventId,
                       arp.col_tasktemplateautoruleparcc as RuleParamTaskTmplId,
                       null as TaskEventId,
                       null as TaskEventProcessorCode,
                       null as RTTaskEventId,
                       null as RTTaskEventProcCode
            from       tbl_autoruleparamcc arp
            inner join tbl_map_taskstateinitcc tsi on arp.col_ruleparcc_taskstateinitcc = tsi.col_id and tsi.col_taskstateinitcc_tasktype =(select col_taskccdict_tasksystype
                       from    tbl_taskcc
    ...
    LOOP
        BEGIN
            insert into tbl_autoruleparamcc(col_ruleparcc_taskstateinitcc,
                          ...
                          col_owner,
                          col_code)
                   values(rec.RTTaskStateInitId,
                          rec.RTTaskEventId,
                          rec.RuleParamCode,
                          rec.RuleParamValue,
                          rec.RuleParamTaskTmplId,
                          rec.RTTaskId,
                          v_createdby,
                          v_createddate,
                          v_modifiedby,
...
*/
    ...
    from   (select    tsi.col_id as DTTaskStateInitId,
            ...
            where      tst.col_id =(select col_taskccdict_tasksystype
                       from    tbl_taskcc
