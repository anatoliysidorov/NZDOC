...
begin
  ...
  begin
    insert into tbl_autoruleparamcc(col_ruleparcc_taskstateinitcc,col_taskeventccautoruleparmcc,col_paramcode,
                                    col_paramvalue,col_tasktemplateautoruleparcc,col_autoruleparamcctaskcc,
                                    col_createdby,col_createddate,col_modifiedby,col_modifieddate,
                                    col_owner, col_code)
    (select s1.RTTaskStateInitId, s1.RTTaskEventId, s1.RuleParamCode, 
            s1.RuleParamValue, s1.RuleParamTaskTmplId, s1.RTTaskId,
