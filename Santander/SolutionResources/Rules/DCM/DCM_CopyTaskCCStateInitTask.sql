...
*/
      INSERT INTO tbl_map_taskstateinitcc 
                  (col_map_taskstateinitcctaskcc,   col_map_tskstinitcc_initmtd, 
                   col_map_tskstinitcc_tskst,  col_processorcode, 
                   col_assignprocessorcode, col_code) 
      (SELECT v_taskid,  COL_MAP_TSKSTINIT_INITMTD, 
              COL_MAP_TSKSTINIT_TSKST,  COL_PROCESSORCODE, 
              COL_ASSIGNPROCESSORCODE, SYS_GUID() 
       FROM   tbl_MAP_TaskStateInitiation 
       WHERE  COL_TASKSTATEINIT_TASKSYSTYPE = v_tasksystypeid); 
