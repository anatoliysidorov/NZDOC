...
) s10 on s10.CaseworkerId in (select CaseworkerId from table(f_DCM_getProxyAssignorList()))
left join
...
where s7.CaseworkerId in (select CaseworkerId from table(f_DCM_getProxyAssignorList()))
