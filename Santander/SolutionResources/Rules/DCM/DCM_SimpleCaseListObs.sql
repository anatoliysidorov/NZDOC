SELECT     --BASIC DATA
       ...
       (SELECT SUM (col_hoursspent)
         ...
         WHERE col_workactivitycase = c.col_id)
          AS HoursSpent,
       --MILESTONE
       /*state_conf.col_id AS    Milestone_Id,
       state_conf.col_name AS Milestone_Name,
       state_conf.col_code AS Milestone_Code*/
       dict_state.col_id   AS MS_StateId,
       dict_state.col_name AS MS_StateName,
    --Goal SLA
    gsla.SlaEventTypeId as GoalSlaEventTypeId, gsla.SlaEventTypeCode as GoalSlaEventTypeCode, gsla.SlaEventTypeName as GoalSlaEventTypeName,
    gsla.SlaDateTime as GoalSlaDateTime,
    --DeadLine (DLine) SLA
    dsla.SlaEventTypeId as DLineSlaEventTypeId, dsla.SlaEventTypeCode as DLineSlaEventTypeCode, dsla.SlaEventTypeName as DLineSlaEventTypeName,
  ...
  FROM tbl_case c
       ...
       LEFT JOIN tbl_dict_casestate dts
          ON c.col_casedict_casestate = dts.col_id
       ...
       /*LEFT JOIN tbl_dict_stateconfig state_conf 
          ON cst.col_msstateconfigcasesystype = state_conf.col_id*/
