...
begin
  ...
  --select GEN_TBL_TASKDEPENDENCYCC.nextval into v_counter from dual;
   ...
   insert into tbl_taskdependencycc(col_taskdpchldcctaskstinitcc,col_taskdpprntcctaskstinitcc,col_type,
                                    col_processorcode,col_taskdependencyorder,col_isdefault,
                                    col_createdby,col_createddate,col_modifiedby,col_modifieddate, 
                                    col_owner, col_code)
   (select tsic2.col_id, tsip2.col_id, td.col_type, 
           td.col_processorcode, td.col_taskdependencyorder, td.col_isdefault,
           td.col_createdby,td.col_createddate,td.col_modifiedby,td.col_modifieddate,
           td.col_owner, sys_guid()
