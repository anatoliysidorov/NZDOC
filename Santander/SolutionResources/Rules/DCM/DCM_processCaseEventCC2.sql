...
begin
  ...
  for rec in (select cs.col_id as col_id, ce.col_processorcode as col_processorcode,
                csi.col_map_casestateinitcccasecc as caseId, csi.col_casestateinitcc_initmtd as initmethod_id,
                csi.col_map_csstinitcc_csst as casestate_id, cst.col_code as casetype, 
                tem.col_code as caseevent, tet.col_code as caseeventtype, 
                im.col_code as caseinitmethod, css.col_code as caseinitstate
                --CURRENT TASK
                from tbl_casecc cs
