...
begin
  ...
  if v_count > 0 then
    ...
    (select v_TaskId,col_map_tskstinit_initmtd,col_map_tskstinit_tskst,col_processorcode,col_assignprocessorcode,col_createdby,col_createddate,col_modifiedby,col_modifieddate
