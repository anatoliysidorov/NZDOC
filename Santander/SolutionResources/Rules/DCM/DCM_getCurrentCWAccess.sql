...
nvl(s8.AccessObjectId, :AccessObjectId) as AccessObjectId, s9.PermissionId as PermissionId,
...
from
(select col_id as PermissionId, col_defaultACL as DefaultACL, col_orderACL as OrderACL from tbl_ac_permission where col_id = :PermissionId) s9
inner join
...
and s7.AccessObjectid = :AccessObjectId
