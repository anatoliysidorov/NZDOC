...
begin
  ...
  begin
   insert into tbl_map_taskstateinitcc(col_map_taskstateinitcctaskcc,col_processorcode,col_assignprocessorcode,
                                       col_map_tskstinitcc_initmtd,col_map_tskstinitcc_tskst,
                                       col_createdby,col_createddate,col_modifiedby,col_modifieddate,
                                       col_owner, col_code)
   (select tsk.col_id, col_processorcode, col_assignprocessorcode, 
           col_map_tskstinittpl_initmtd, col_map_tskstinittpl_tskst, 
