SELECT
           ...
           selg.SlaDateTime as GoalSlaDateTime,
           --DeadLine (DLine) SLA
           'DEADLINE' as DLineSlaEventTypeCode,
           'Deadline' as DLineSlaEventTypeName,
           seld.SlaDateTime as DLineSlaDateTime,
           ----
           /*--CALCULATED*/
...
LEFT JOIN vw_DCM_SlaEventListVW selg       ON t.col_id = selg.TaskId AND selg.SlaEventTypeCode = 'GOAL'
LEFT JOIN vw_DCM_SlaEventListVW seld       ON t.col_id = selg.TaskId AND selg.SlaEventTypeCode = 'DEADLINE'
