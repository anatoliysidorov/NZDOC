...
begin
  ...
  begin
    insert into tbl_slaeventcc(col_slaeventcctaskcc, col_slaeventcc_slaeventtype, col_slaeventcc_dateeventtype, col_intervalds, col_intervalym, col_slaeventcc_slaeventlevel, col_maxattempts, col_attemptcount, col_slaeventorder)
