...
where lower(s9.accessobjecttypecode) = (case when :AccessObjectTypeCode is null then lower(s9.accessobjecttypecode) else cast(lower(:AccessObjectTypeCode) as nvarchar2(255)) end)
and lower(s9.permissioncode) = (case when :PermissionCode is null then lower(s9.permissioncode) else cast(lower(:PermissionCode) as nvarchar2(255)) end)
